...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "#81a1c1", "#E7ECF4" }, angle = 90 },
...
hl.animation({ leaf = "windows", enabled = true, speed = 3.2, bezier = "quick" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3.2, bezier = "quick" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3.2, bezier = "quick" })
